...
%	For a more intuitive comparison, Fig. \ref{Fig:CMP McTwo} offers the line chart of maximal \(Acc\) achieved by the two algorithms on 17 datasets, where MGRFE obviously outperforms McTwo with a higher \(Acc\) line. 	
...
%			\centering
%			\includegraphics[height=1.55in]{pictures/SRBCT-RFE.pdf}
%		\end{minipage}
%		\begin{minipage}[t]{0.3\textwidth}
%			\centering
%			\includegraphics[height=1.55in]{pictures/ALLAML-RFE.pdf}
%		\end{minipage}
%		\begin{minipage}[t]{0.3\textwidth}
%			\centering
%			\includegraphics[height=1.55in]{pictures/MLL-RFE.pdf}
%		\end{minipage}
%		\caption{Three typical GA-RFE processes on the three benchmark datasets from Dataset Two.}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,clip,keepaspectratio]{pictures/CP-photo.eps}}]{Cheng Peng} 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,clip,keepaspectratio]{pictures/YL-photo.eps}}]{Ying Li} 
