	...
	\resizebox{0.75\textwidth}{!}{
		\begin{threeparttable}
			...
			\begin{tabular}{cccccccccc}
				\toprule
				Feature From / \#Features & Feature Tested / \#Features & \#Samples & Classifier & Sn & Sp & Acc & Avc & MCC & AUC\\
				\midrule
				\multirow{3}{*}{Leuk / 2} & \multirow{3}{*}{MLL / 4} & \multirow{3}{*}{52}  &
				NB & 0.963  & 0.955  & 0.961  & 0.959  & 0.929  & 0.993\\
				&  &  & SVM & 0.935  & 0.887  & 0.913  & 0.911  & 0.844  & 0.975\\
				&  &  & RF & 0.960  & 0.955  & 0.959  & 0.958  & 0.925  & 0.977\\
				\multirow{3}{*}{Gas1 / 2} & \multirow{3}{*}{Gas2 / 3} & \multirow{3}{*}{124}  &
				NB & 0.968  & 0.966  & 0.967  & 0.967  & 0.937  & 0.993\\
				&  &  & SVM & 0.952  & 0.982  & 0.967  & 0.967  & 0.937  & 0.992\\
				&  &  & RF & 0.957  & 0.931  & 0.944  & 0.944  & 0.895  & 0.987\\
				\multirow{3}{*}{Gas2 / 3} & \multirow{3}{*}{Gas1 / 2} & \multirow{3}{*}{144}  &
				NB & 0.949  & 0.968  & 0.958  & 0.958  & 0.920  & 0.975\\
				&  &  & SVM & 0.941  & 0.972  & 0.956  & 0.956  & 0.916  & 0.970\\
				...
				\multirow{3}{*}{Prostate / 4} & \multirow{3}{*}{GSE8511 / 5} & \multirow{3}{*}{41}  &
				NB & 0.884  & 0.852  & 0.870  & 0.868  & 0.753  & 0.935\\
				&  &  & SVM & 0.900  & 0.665  & 0.806  & 0.783  & 0.582  & 0.900\\
				&  &  & RF & 0.868  & 0.752  & 0.822  & 0.810  & 0.646  & 0.917\\
				\multirow{3}{*}{Gastric / 3} & \multirow{3}{*}{GSE2685 / 1} & \multirow{3}{*}{30}  &
				NB & 0.919  & 0.650  & 0.846  & 0.785  & 0.584  & 0.861\\
				&  &  & SVM & 0.990  & 0.440  & 0.843  & 0.715  & 0.464  & 0.865\\
				&  &  & RF & 0.862  & 0.500  & 0.765  & 0.681  & 0.365  & 0.686\\
				\multirow{3}{*}{Gastric / 3} & \multirow{3}{*}{GSE66229 / 7} & \multirow{3}{*}{400}  &
				NB & 0.903  & 0.896  & 0.902  & 0.900  & 0.764  & 0.961\\
				&  &  & SVM & 0.955  & 0.864  & 0.932  & 0.909  & 0.823  & 0.971\\
				&  &  & RF & 0.950  & 0.894  & 0.936  & 0.922  & 0.835  & 0.971\\
				\multirow{3}{*}{Adenoma / 1} & \multirow{3}{*}{GSE8514 / 3} & \multirow{3}{*}{15}  &
				NB & 0.900  & 0.800  & 0.867  & 0.850  & 0.700  & 0.960\\
				&  &  & SVM & 0.900  & 0.500  & 0.767  & 0.700  & 0.400  & 0.920\\
				&  &  & RF & 0.910  & 0.820  & 0.880  & 0.865  & 0.730  & 0.950\\
				\multirow{3}{*}{Colon / 6} & \multirow{3}{*}{GSE44076 / 23} & \multirow{3}{*}{148}  &
				NB & 0.988  & 0.950  & 0.976  & 0.969  & 0.948  & 0.996\\
				&  &  & SVM & 0.969  & 0.952  & 0.963  & 0.961  & 0.924  & 0.995\\
				&  &  & RF & 0.977  & 0.960  & 0.972  & 0.969  & 0.940  & 0.998\\
			...
			\end{tabular}
			\begin{tablenotes}
				\item On the tested datasets with sample number greater than 50, 10-time 10-fold cross validation were performed with different random seeds. Meanwhile, 10-time 5-fold cross validation were performed on datasets with samples less than 50.
				\item The later seven validation datasets are retrieved from GEO and named as their GEO accessions.
				\item NB, SVM and RF represent Naive Bayes, Support Vector Machine and Random Forest classifiers, respectively. 
				\item The bold face values denote the highest performance achieved by classifiers. 
			\end{tablenotes}
		\end{threeparttable}}
	\end{table*}
