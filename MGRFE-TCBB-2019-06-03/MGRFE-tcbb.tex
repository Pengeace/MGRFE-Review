...
\begin{document}
	...
	\begin{figure*}[!htbp]
		\centering
		\includegraphics[width=0.57\textwidth]{pictures/MGRFE-whole}
	...
	The information of the 19 datasets in the two large datasets is given in Tables 1 and 2 in Supplementary Material. All these datasets can be downloaded directly from \url{https://github.com/Pengeace/MGRFE-GaRFE}.
	...
	\subsubsection{Stage 3: Multiple \textit{k}-fold CV to select the final gene combination}
	
	Stage 3 is aimed at finding the optimal gene combination with the best classification performance and minimal variance among different CV processes. The \textit{k}-fold CV is used for calculating the fitness of a GA individual. Multiple \textit{k}-fold CV based on different random seeds is performed to further validate and select the final optimal gene combination.
	...
	\begin{figure*}[htbp]
		\centering
		\includegraphics[width=0.72\textwidth]{pictures/CV1}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.45\textwidth]{pictures/CV2}
	...
	\begin{table*}[htbp]
	\centering\caption{Independent validation of selected gene features by MGRFE with 10-time $k$-fold cross validation.}
	\label{Tab:vali}
		...
		\begin{threeparttable}
			...
			\begin{tabular}{cccccccccc}
				...
				\begin{tabular}{c}
					Feature Tested /\\
					\#Features
				\end{tabular}&\#Samples& Classifier& \textit{Sn} &\textit{Sp}& \textit{Acc}& \textit{Avc}& \textit{MCC}& \textit{AUC}\\
				\toprule
				
				%
				&&&NB&\textbf{0.963}&\textbf{0.955}&\textbf{0.961}&\textbf{0.959}&\textbf{0.929}&\textbf{0.993}\\
				&&&SVM&0.935&0.887&0.913&0.911&0.844&0.975\\
				
				\multirow{-3}*{Leuk / 2}&\multirow{-3}*{MLL / 4}&\multirow{-3}*{52}&RF& 0.960 &\textbf{0.955}& 0.959& 0.958& 0.925 &0.977\\
				
				\hline
				
				&&&NB& \textbf{0.968} &\textbf{0.966}& \textbf{0.967}&\textbf{ 0.967}& \textbf{0.937}& \textbf{0.993}\\
				&&&SVM& 0.952 &\textbf{0.982} &\textbf{0.967} &\textbf{0.967} &\textbf{0.937}& 0.992\\
				\multirow{-3}*{Gas1 / 2}&\multirow{-3}*{Gas2 /  3}&\multirow{-3}*{124}&RF &0.957& 0.931 &0.944& 0.944 &0.895& 0.987\\
				
				\hline
				
				&&&NB& \textbf{0.949} &0.968 &\textbf{0.958}& \textbf{0.958} &\textbf{0.920} &\textbf{0.975}\\
				&&&SVM &0.941 &\textbf{0.972} &0.956& 0.956& 0.916 &0.970\\
				
				\multirow{-3}*{Gas2 / 3}&\multirow{-3}*{Gas1 / 2}&\multirow{-3}*{144}&RF& 0.936& 0.958 &0.947& 0.947& 0.900& 0.974\\
				
				\midrule
				
				\multirow{3}*{DLBCL / 3}& \multirow{3}*{GSE56315 / 7} &\multirow{3}*{88}
				...
				\multirow{-3}*{Prostate / 4} &\multirow{-3}*{GSE8511 / 5}& \multirow{-3}*{41}&RF &0.868 &0.752 &0.822& 0.810 &0.646 &0.917\\
				
				\hline
				
				\multirow{3}*{Gastric / 3} &\multirow{3}*{GSE2685 / 1 }&\multirow{3}*{30}
				...
				\multirow{-3}*{Gastric / 3}&\multirow{-3}*{ GSE66229 / 7}&\multirow{-3}*{ 400}&RF &0.950 &0.894 &\textbf{0.936} &\textbf{0.922} &\textbf{0.835} &\textbf{0.971}\\
				
				\hline
				
				\multirow{3}*{Adenoma / 1}& \multirow{3}*{GSE8514 / 3}&\multirow{3}*{ 15}
				...
				\multirow{-3}*{Colon / 6}& \multirow{-3}*{GSE44076 / 23}&\multirow{-3}*{ 148}&RF &0.977 &\textbf{0.960}& 0.972&\textbf{0.969} &0.940 &\textbf{0.998}\\				
				\hline			
				\multirow{3}*{ALL1 / 1}&\multirow{3}*{ GSE2604 / 4 }&\multirow{3}*{14}
				&NB& \textbf{1.000}& \textbf{1.000}& \textbf{1.000}& \textbf{1.000}& \textbf{1.000}& \textbf{1.000}\\
				&&&SVM& \textbf{1.000}& \textbf{1.000}& \textbf{1.000}& \textbf{1.000}& \textbf{1.000}& \textbf{1.000}\\
				&&&RF& \textbf{1.000} &\textbf{1.000} &\textbf{1.000} &\textbf{1.000} &\textbf{1.000}& \textbf{1.000}\\				
...
\section*{Acknowledgments}
	...
	The authors would like to thank the National Natural Science Foundation of China [Grant number 61572105, 61872418 and 71774154] and the Natural Science Foundation of Jilin Province (20180101331JC).
...
\begin{IEEEbiography}[{\includegraphics[width=1in,clip,keepaspectratio]{pictures/CP-photo}}]{Cheng Peng} 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,clip,keepaspectratio]{pictures/YL-photo}}]{Ying Li} 
